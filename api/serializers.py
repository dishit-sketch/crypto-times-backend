...
class SourceSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = [
            ...
            "description", "reliability_score", "created_at",
        ]
...
class NewsArticleDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = NewsArticle
        fields = [
            "id", "title", "summary", "content", "images",
            "source_name", "source_logo", "source_url",
            "original_url", "author",
            "ai_verdict", "confidence_score",
            "key_points",
            "status", "is_breaking", "category", "tags",
            "verification_logs",
